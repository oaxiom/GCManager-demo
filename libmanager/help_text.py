...
<p>To get started the system must first be validated by activating the system with a specific key. This key can be obtained by clicking ‘Get activation code’. It is important that the user copies this code to another location as it will not be provided again.
...
<p>This page shows the current analysis stage of the system. It shows the stage completion for the currently analysis, as well as the number of samples on the queue. The system is automatic, and will process the queue ion order.
